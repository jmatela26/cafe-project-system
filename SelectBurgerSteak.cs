...
{
    public partial class SelectBurgerSteak : Form
    {
        int orderNo, pass;
        public SelectBurgerSteak(int ord, int from)
        {
            InitializeComponent();
            orderNo = ord;
            pass = from;
        ...
        {
            GetOrder.placeOrder(orderNo, "RM03");
        ...
        private void Btn_2Pc_Click(object sender, EventArgs e)
        {
            GetOrder.placeOrder(orderNo, "RM03A");
